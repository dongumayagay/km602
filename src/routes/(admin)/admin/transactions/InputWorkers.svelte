...
<div class="form-control" >
    <label for="#" class="label">
      ...
      <div class="max-w-md h-13 border border-gray-300 rounded-lg p-3 text-sm font-semibold text-gray-700" on:click|preventDefault|stopPropagation={toggleActive}>{selected.length ? selected.join(", ") : 'Pick workers'}</div>
</div>

{#if isActive}
<div class="flex flex-col gap-3 px-2 py-3 border max-w-md max-h-32 overflow-y-auto">
